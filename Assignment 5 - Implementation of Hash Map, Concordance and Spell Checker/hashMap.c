...
{
    // FIXME: implement
    struct HashMap *hashTable = map;
    struct HashLink *currentLink, *previousLink;
    int i;
...
void hashMapRemove(HashMap* map, const char* key)
{
    ...
    while (currentLink != NULL && (strcmp(currentLink->key, key) != 0)) {
        previousLink = currentLink;
        currentLink = currentLink->next;
    }
    
    if (currentLink != NULL && (strcmp(currentLink->key, key) == 0)) {
